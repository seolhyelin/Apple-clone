(() => {
  ...
  let prevScrollHeight = 0; //현재 스크롤위치(yOffset)보다 위에 스크롤 섹션들의 스크롤 높이 합
  ...
  function setLayout() {
    ...
    for (let i = 0; i < sceneInfo.length; i++) {
      ...
      sceneInfo[
        i
      ].objs.container.offsetHeight = `${sceneInfo[i].scrollHeight}px`;
    }
    ...
    sceneInfo[0].objs.canvas.style.transform = `translate3d(-50%, -50%, 0) scale(${heightRatio})`; //창사이즈 높이에 맞춰 캔버스 크기 결정
